...
export const WOMEN_MODULES: Module[] = [
  ...
  },
  {
    ...
    body: "UPI is safe, free, and increasingly essential. Students learn to set up Google Pay, PhonePe, or BHIM; the absolute UPI safety rules (you never need to enter a PIN to receive money; asking you to is always a scam); how to use mobile wallets without exposing larger savings; and how to recognise online fraud.",
  },
  {
    num: "10",
    title: "Emergency Plan",
    teaser: "It is not about if an emergency happens. It is about when.",
    body: "The ideal emergency fund is three months of total expenses, kept somewhere safe and accessible. The module covers how to build the fund using Jar 3 from Module 02, the order of operations in a real emergency (use the fund, then banks or SHGs, then employer advance, then family, and never moneylenders), and which documents to keep ready.",
  },
];
